...
function Search() {
    ...
    if (Tid == 'tabitem1') {
        ...
        arr[1] = 11;
        GridLoadIDAll("BLL_OriginalDataDts", "GetSSBViewData", "GetSSBViewDataCount", arr, "OtherDataTuiFei");
    }
...
function InitControl() {
    ...
    if (Tid == 'tabitem1') {
        ...
        gridManager = $("#OtherDataTuiFei").ligerGrid({
            columns: [
                { display: '客户名称', name: 'ODD_Name', minWidth: 90 },
                { display: '座机号码', name: 'ODD_Phone', minWidth: 90 },
                { display: '会员业务', name: 'ODD_Business', minWidth: 90 }
    ...
    GridInitIDControl("OtherDataTuiFei");
...
function GeneralVaildData() {
    var arr = new Array();
    arr[0] = StuffCode;
    ReturnMethod("BLL_OriginalDataDts", "SaveSSBGeneralDatas", arr, Address, "SaveDataSuccess");
}
