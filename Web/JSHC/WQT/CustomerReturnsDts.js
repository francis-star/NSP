...
function InitControl() {
    ...
    var arr = new Array();
    arr[0] = CustCode;
    var Result = eval("(" + ReturnValue("BLL_CustomerReturnsDts", "GetWQTBilllist", arr, Address) + ")");
...
function InitData() {
    var arr = new Array();
    arr[0] = CustCode;
    ReturnMethod("BLL_CustomerReturnsDts", "GetWQTDetails", arr, Address, "GetDataSuccess");
...
function Exam() {
    if (VaildData()) {
        ...
        ReturnMethod("BLL_CustomerReturnsDts", "ModWQTState", arr, Address, "SaveQuitSuccess");
    }
}
