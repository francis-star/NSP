...
function Search() {
    ...
    if (Tid == 'tabitem1') {
        ...
        arr[1] = 9;
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetWQTViewDataCount", arr, "HighKeyWordData");
    }
    else {
        arr[1] = 8;
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetWQTViewDataCount", arr, "OtherData");
    }
