...
function Search() {
    ...
    if (Tid == 'tabitem1') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetWQTViewDataCount", arr, "ValidData");
    }
    else if (Tid == 'tabitem2') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetWQTViewDataCount", arr, "AlreadyUser");
    }
    else if (Tid == 'tabitem3') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetWQTViewDataCount", arr, "UnsubscribeUser");
    }
    else if (Tid == 'tabitem4') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetWQTViewDataCount", arr, "AlreadyCallData");
    }
    else if (Tid == 'tabitem5') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetWQTViewDataCount", arr, "LoopData");
    }
    else if (Tid == 'tabitem6') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTBlackData", "GetWQTBlackDataCount", arr, "BlackUser");
    }
    else if (Tid == 'tabitem7') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetWQTViewDataCount", arr, "KeyWordData");
    }
    else if (Tid == 'tabitem8') {
        arr[1] = 9;
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetViewDataCount", arr, "HighKeyWordData");
    }
    else {
        arr[1] = 8;
        GridLoadIDAll("BLL_OriginalDataDts", "GetWQTViewData", "GetViewDataCount", arr, "OtherData");
    }
...
function GeneralDatas() {
    var arr = new Array();
    arr[0] = StuffCode;
    ReturnMethod("BLL_OriginalDataDts", "GeneralWQTDatas", arr, Address, "GeneralDataSuccess");
}
...
function GeneralVaildData() {
    var arr = new Array();
    arr[0] = StuffCode;
    ReturnMethod("BLL_OriginalDataDts", "SaveWQTGeneralDatas", arr, Address, "SaveDataSuccess");
}
...
function Move() {
    ...
    layer.open({
        ...
        , yes: function (index, layero) {
            ...
            var result = ReturnValue("BLL_OriginalDataDts", "MoveWQTScreenData", arr, Address);
            if (result == "true") {
