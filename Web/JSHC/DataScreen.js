...
function Search() {
    ...
    if (Tid == 'tabitem1') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetViewData", "GetViewDataCount", arr, "ValidData");
    }
    else if (Tid == 'tabitem2') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetViewData", "GetViewDataCount", arr, "AlreadyUser");
    }
    else if (Tid == 'tabitem3') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetViewData", "GetViewDataCount", arr, "UnsubscribeUser");
    }
    else if (Tid == 'tabitem4') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetViewData", "GetViewDataCount", arr, "AlreadyCallData");
    }
    else if (Tid == 'tabitem5') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetViewData", "GetViewDataCount", arr, "LoopData");
    }
    else if (Tid == 'tabitem6') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetBlackData", "GetBlackDataCount", arr, "BlackUser");
    }
    else if (Tid == 'tabitem7') {
        GridLoadIDAll("BLL_OriginalDataDts", "GetViewData", "GetViewDataCount", arr, "KeyWordData");
    }
    else if (Tid == 'tabitem8') {
        arr[1] = 9;
        GridLoadIDAll("BLL_OriginalDataDts", "GetViewData", "GetViewDataCount", arr, "HighKeyWordData");
    }
    else
    {
        arr[1] = 8;
        GridLoadIDAll("BLL_OriginalDataDts", "GetViewData", "GetViewDataCount", arr, "OtherData");
    }
...
function GeneralDatas() {
    var arr = new Array();
    arr[0] = StuffCode;
    ReturnMethod("BLL_OriginalDataDts", "GeneralDatas", arr, Address, "GeneralDataSuccess");
}
...
function GeneralVaildData() {
    var arr = new Array();
    arr[0] = StuffCode;
    ReturnMethod("BLL_OriginalDataDts", "SaveGeneralDatas", arr, Address, "SaveDataSuccess");
}
    ...
    layer.open({
        ...
        content: '<div style="margin-top:20px;padding:0 90px;">' + butn + '</div>'
            ...
            , yes: function (index, layero) {
                ...
                var result = ReturnValue("BLL_OriginalDataDts", "MoveScreenData", arr, Address);
                if (result == "true") {
