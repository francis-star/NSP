...
function InitControl() {
    ...
    var strData = [{ 'text': '9' }, { 'text': '15' }, { 'text': '18' },{ 'text': '20' }, { 'text': '25' }, { 'text': '30' }];
...
function InitData() {
    var arr = new Array();
    arr[0] = Code;
    OrginData = eval(ReturnValue("BLL_OriginalData", "GetMQYOriginData", arr, Address));
}
...
function UpdateDatas() {
    if (validata()) {
        ...
        ReturnMethod("BLL_OriginalData", "UpdateMQYDatas", arr, Address, "UpdateDatas");
    }
}
