...
function GeneralDatas() {
    var arr = new Array();
    arr[0] = StuffCode;
    ReturnMethod("BLL_OriginalDataDts", "GeneralMQYDatas", arr, Address, "GeneralDataSuccess");
}
...
function GeneralVaildData() {
    var arr = new Array();
    arr[0] = StuffCode;
    ReturnMethod("BLL_OriginalDataDts", "SaveGeneralMQYDatas", arr, Address, "SaveDataSuccess");
}
    ...
    layer.open({
        ...
        content: '<div style="margin-top:20px;padding:0 90px;">' + butn + '</div>'
            ...
            , yes: function (index, layero) {
                ...
                var result = ReturnValue("BLL_OriginalDataDts", "MoveMQYScreenData", arr, Address);
                if (result == "true") {
