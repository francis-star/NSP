            ...
            getHtml: function(){
                ...
                if(self.type != "mini"){
                    ...
                    switch(self.type){
                        ...
                        case "onceConfirm" :
//                            if(IsSubscribe=="0"){
//                                html += '<a href="http://mp.weixin.qq.com/s?__biz=MzA3MDcyODQ4Mw==&mid=208558051&idx=1&sn=d52c07cbae99ad90c2b98096a6b5ecf4#rd" class="alert-confirm single">'+self.confirmText+'</a>';
//                            }else{
                                html += '<a  href="javascript:;" id="no89757" class="alert-confirm single">'+self.confirmText+'</a>';
//                            }
                            break;
                    }
                    html += '</div></div>';
